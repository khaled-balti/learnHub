            ...
            <div className="container my-5">
                <div className="container d-none d-md-flex justfy-content-md-between align-items-md-center">
                    <div className={`container d-flex flex-column justfy-content-between align-items-center ${classes.container2} m-0 p-0 me-3`}>
                        <Link to="/courses/web" className={`container ${classes.container3} m-0 mb-3 p-0 overflow-hidden position-relative`}><motion.div  variants={{hidden1: {scale: 0}, visible1: {scale: 1}}} initial="hidden1" animate={image1Control} ref={image1Ref} transition={{duration: 0.4}}>
                        ...
                        <div className={`container d-flex justfy-content-between align-items-center m-0 p-0 mb-3 ${classes.container4}`}>
                            <Link to="/courses/graphic" className={`container ${classes.container5} overflow-hidden position-relative m-0 p-0 me-3`}><motion.div variants={{hidden2: {scale: 0}, visible2: {scale: 1}}} initial="hidden2" animate={image2Control} ref={image2Ref} transition={{duration: 0.4 , delay: 0.2}}>
                            ...
                            <Link to="/courses/video" className={`container ${classes.container6} overflow-hidden position-relative m-0 p-0`}><motion.div variants={{hidden3: {scale: 0}, visible3: {scale: 1}}} initial="hidden3" animate={image3Control} ref={image3Ref} transition={{duration: 0.4 , delay: 0.4}}>
                    ...
                    <Link to="/courses/marketing" className={`container ${classes.container1} overflow-hidden position-relative m-0 p-0`} ><motion.div variants={{hidden4: {scale: 0}, visible4: {scale: 1}}} initial="hidden4" animate={image4Control} ref={image4Ref} transition={{duration: 0.4 , delay: 1}}>
                ...
                <div className="row mx-auto d-block d-md-none">
                        <Link to="/courses/web" ><div className={`container col-12 overflow-hidden position-relative mb-3`}>
                            <img src={Course1} alt="error" className="img-fluid" ></img>
                            <CourseCaption title="Web Design" courses={web + '  courses'}/>
                        </div></Link>
                        <Link to="/courses/graphic" ><div className={`container col-12 overflow-hidden position-relative mb-3`}>
                            <img src={Course2} alt="error" className="img-fluid"></img>
                            <CourseCaption title="Graphic Design" courses={design + '  courses'}/>
                        </div></Link>
                        <Link to="/courses/video" ><div className={`container col-12 overflow-hidden position-relative mb-3`}>
                            <img src={Course3} alt="error" className="img-fluid"></img>
                            <CourseCaption title="Video Editing" courses={montage + '  courses'}/>
                        </div></Link>
                        <Link to="/courses/marketing" ><div className={`container col-12 overflow-hidden position-relative mb-3`}>
